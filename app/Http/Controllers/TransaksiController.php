...
class TransaksiController extends Controller
{
    ...
    public function create()
    {
        ...
        $montir = Montir::all();
        $service = Service::all();
        $sekarang = Carbon::today()->isoFormat('D M Y');
        return view('frontEnd.page.index', compact('barang', 'montir', 'service', 'sekarang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // $sekarang = Carbon::today()->isoFormat('D M Y');
        // $search = Transaksi::where('tgl_boking','==', $request->tgl_boking)->where('id_user',Auth::user()->id)->exists();
        // if ($search) {
